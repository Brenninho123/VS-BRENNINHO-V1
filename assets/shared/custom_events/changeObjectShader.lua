local shaders = {'lenses', 'chromaticPincush', 'susLmao', 'rain', 'redstuff', 'eggmanflare', 'gamecamshader', 'gamecamshader1', 'fadein', 'newscroll', 'pulse', 'heateffect' ,'chromaticLens', 'glitch', 'glitchshader', 'smoke', 'radialBlur', 'fire', 'bloom', 'blaze', 'redlights', 'movingChromaticAbber'}
local objects = {}
local time = 0
